...
public class Main {
	...
	public static String student_txt_path = "C:\\Users\\ASUS\\Desktop\\FINAL\\SchoolCourseManagement\\studentsList.txt"; 
	public static String teacher_txt_path = "C:\\Users\\ASUS\\Desktop\\FINAL\\SchoolCourseManagement\\src\\teacher.txt";
	private static String child_image_path = "C:\\Users\\ASUS\\Desktop\\FINAL\\SchoolCourseManagement\\PngItem_1746580.png"; // child image
	private static String teacher_image_path = "C:\\Users\\ASUS\\Desktop\\FINAL\\SchoolCourseManagement\\unnamed.png"; // teacher image
	private static String manager_image_path = "C:\\Users\\ASUS\\Desktop\\FINAL\\SchoolCourseManagement\\manager3.png";// manager image
	private static String welcome_png_path = "C:\\Users\\ASUS\\Desktop\\FINAL\\SchoolCourseManagement\\entranceWelcome.jpg"; // entrance image
					    				...
					    				public void actionPerformed(ActionEvent arg0) {					    						
					    					//MANAGER SELECTION=ADD STUDENT
						    					...
						    					else if(deleteTeacher.isSelected())
						    					{
						    						...
						    						JLabel lblNewLabel2 = new JLabel(""); //***********************************************  yeni eklendi
						    						lblNewLabel2.setIcon(new ImageIcon(manager_image_path));
						    						lblNewLabel2.setBounds(275, 30, 250, 200);
					...
					if(flag) {
						...
						//Manager addTeacher() FUNCTION USED, IF TEACHER DOES NOT EXIST IN THE SYSTEM TRUE RETURNED
						 ...
						 if(canBeAdded) {
							    ...
							    JOptionPane.showMessageDialog(frmManagerMenu, "Teacher has been enrolled succesfully!" ,"Information",JOptionPane.INFORMATION_MESSAGE);	 
						 }
						 	//CLEARING TEXT FIELDS FOR REPETEDLY STUDENT ENROLLMENT
						 	teacherName.setText("");
				    		teacherSurname.setText("");
